...
const Home = () => {
  const [log] = useAtom(login);
  const [per] = useAtom(person);
  ...
  return (
    <div>
      <Navbar />
      <div className="main h-[100vh] bg-black relative">
        <div className="backbtn text-white pl-16 pt-10 text-xl">
          <p>Back to Questions</p>
        </div>
        <div className="content_sec max-w-xl mt-10 m-auto rounded overflow-hidden">
          <div className="content bg-white overflow-hidden">
            <div className="m-7">
              <div className="flex gap-4">
                <p className="px-4 py-2 bg-[#A9D9FF] rounded-lg">Design</p>
                <p className="px-4 py-2 bg-[#A9D9FF] rounded-lg">Technology</p>
              </div>
        ...
        <div className="feadback absolute right-8 top-[35%]">
          <div
            className={`main1 text-white mb-16 ${
              feedoption ? "invisible" : ""
            }`}
          >
            <div className="fabOptions flex flex-col items-end gap-6">
              <div className="box flex items-center cursor-pointer">
                <p className="py-2 px-4 mr-4 bg-[#F8F8F8] text-black font-semibold rounded">
                  Report an Issue
                </p>
                <svg
                  className="overflow-visible  bg-white p-2.5 rounded-[50%] cursor-pointer"
                  width="50"
                  height="50"
                  // viewBox="0 0 23 24"
                  fill="none"
              ...
              <div className="box flex items-center cursor-pointer">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_2867_3515)">
                    <path
                    ...
                    <path
                      ...
                      fill="#F8F8F8"
                      stroke="#F8F8F8"
                      stroke-width="0.404439"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_2867_3515">
          ...
          <div className="icon relative mt-2.5">
            {feedoption ? (
              <svg
                className="overflow-visible absolute right-0 bottom-0 bg-white p-2.5 rounded-[50%] cursor-pointer"
                width="50"
                height="50"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <g clip-path="url(#clip0_1_4876)">
                  ...
                  />
                  <path
                    d="M3.48438 6.96899L17.4222 6.96899"
                    stroke="#F8F8F8"
                    stroke-width="1.74222"
                    stroke-linecap="round"
                  />
                  <path
                    d="M3.48438 11.615L17.4222 11.615"
                    stroke="#F8F8F8"
                    stroke-width="1.74222"
                    stroke-linecap="round"
                  />
                  <path
                    d="M3.48438 16.261L17.4222 16.261"
                    stroke="#F8F8F8"
                    stroke-width="1.74222"
                    stroke-linecap="round"
                  />
                  ...
                  />
                  <path
                    d="M25.2999 13.6072L16.5798 28.7109L16.9486 33.0491C17.0171 33.8548 17.8674 34.3457 18.5994 34.0022L22.5409 32.1525L31.261 17.0488C31.9025 15.9378 31.5218 14.5171 30.4108 13.8756L28.4732 12.7569C27.3621 12.1155 25.9414 12.4961 25.2999 13.6072Z"
                    fill="#0F0F0F"
                    stroke="#F8F8F8"
              ...
              >
                <path
                  d="M1.99976 2.00146L21.9998 22.0009M1.99976 22.0009L21.9998 2.00146"
                  stroke="#0F0F0F"
                  stroke-width="3.99994"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
              </svg>
